...
<h2>Unité 3.3 : Incertitude</h2>

<figure>
  <img src="../images/kneeling-in-waters.png" alt='Un scientifique creuse pour trouver des palourdes au cours d’une activité de relevé.'>
  <figcaption>Relevé de 2022 du programme chargé des mollusques du Pacifique du MPO.<br>
...
<p>L’incertitude peut avoir diverses sources, notamment : </p>
    <ol class='lst-spcd'>
      <li>variabilité naturelle de la dynamique des populations (p. ex. différents niveaux de recrutement d’une année à l’autre)&nbsp;;</li>
      <li>la dynamique des populations utilisée dans la modélisation (p. ex. relations prédateur-proie, relations stock-recrutement, facteurs environnementaux et climatiques) n’est pas comprise&nbsp;;</li>
      <li>données manquantes (p. ex. prises non déclarées)&nbsp;;</li>
      <li>erreur de mesure et d’échantillonnage&nbsp;;</li>
      <li>on ne sait pas dans quelle mesure les politiques de gestion seront mises en œuvre avec succès (p. ex. la mesure avec laquelle les prises correspondront aux projections du total autorisé des captures, les changements apportés à la politique).</li>
