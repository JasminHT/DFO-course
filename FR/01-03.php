...
<aside class='bg-info'>
  ...
  <ul>
    ...
    <li>un sous-ensemble plus petit d’une population&nbsp;;</li>
    <li>plus d’une population.</li>
  </ul>
</aside>
...
<aside>
  ...
  <img  src="../images/sockeye-salmon.png" alt="saumon rose">
  <figcaption>Source de la photo : MPO
</figcaption>
</figure>
  

  <h3>Exemple : saumon rouge</h3>
  <p>Les stocks de saumon du Pacifique sont souvent composés de plusieurs populations qui se reproduisent dans différentes rivières. Une <b>unité de conservation (UC)</b> est un groupe de saumons sauvages qui est isolé des autres groupes. Si une UC disparaît localement, il est peu probable qu’elle recolonise cette zone. Une UC peut être composée d’une ou de plusieurs populations. Les <b>zones de gestion des stocks (ZGS)</b> sont des ensembles de stocks qui sont gérés conjointement avec un état du stock commun. Il y a 216 UCs de saumon rouge qui constituent 16 ZGS.</p>

</aside>

<aside>
  <figure style='float:left;width:50%;margin:  36px 1em 0;'>
  <img  src="../images/fish-closeup.png" alt="Maquereau bleu">
  <figcaption>Source de la photo : Gilbert van Ryckevorsel
</figcaption>
</figure>
  

  <h3>Exemple : maquereau</h3>
  <p>Une population de maquereau est présente sur toute la côte est, du Labrador à la Caroline du Nord. Cependant, le stock de maquereau géré par le Ministère des Pêches et des Océans Canada (MPO) ne comprend que les poissons qui se trouvent dans les eaux canadiennes, du Labrador à la Nouvelle-Écosse, y compris le golfe du Saint-Laurent.</p>
