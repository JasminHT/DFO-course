...
<p>Les modèles peuvent mettre à l’essai des options de gestion dans un environnement virtuel à faible coût et à faible risque.</p>
...
<p>Les scientifiques doivent communiquer les risques aux gestionnaires en produisant des avis qui expriment l’incertitude associée à la prise de différentes mesures de gestion.</p>
...
<div class='collapsible blue' id="module2">
  <details>
    ...
    <aside class='bg-info'>La <strong>probabilité</strong> est la mesure dans laquelle un événement ou un scénario est susceptible de se produire. </aside>
  </details>
</div>
