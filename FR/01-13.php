...
<aside class='bg-info'>Le <strong>rendement maximal durable (RMD)</strong> est la prise annuelle moyenne maximale qui peut être prélevée d’un stock sur une période indéfinie dans les conditions environnementales actuelles. Autrement dit, il s’agit de la récolte maximale qu’un stock peut soutenir sans nuire à sa croissance naturelle et à sa reconstitution. </aside>

<p>La <strong>B<sub>RMD</sub></strong> correspond à la <span class="gc-dwnld-info"><abbr title="Biomasse (B) : Le poids total de tous les poissons d’un stock.">biomasse</abbr></span> moyenne provenant de la récolte d’un stock et qui permet d’offrir le rendement maximal durable au taux de croissance maximal.</p>
...
<figure class='image-transcript' >
      <img alt=''      src="../images/MSY-FR.png">
        <figcaption style="margin-top: 5px !important">
          ...
          <p>Cette figure illustre de façon simplifiée la relation entre le rendement, sur l’axe des ordonnées, et la biomasse du stock, sur l’axe des abscisses. L’indice de la biomasse est représenté par la ligne noire pleine. Le sommet de la courbe, identifié par RMD, est le point correspondant aux prises annuelles moyennes les plus importantes à long terme qui peuvent être prélevées d’un stock dans les conditions environnementales en vigueur.  </p>
