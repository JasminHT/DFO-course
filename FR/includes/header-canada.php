      ...
      <div class="row">
        <section id="wb-lng" class="col-xs-3 col-sm-12 pull-right text-right">
          ...
          <ul class="list-inline mrgn-bttm-0">
            <li>
              <?php
              $eng_link = str_replace("FR", 'EN', $_SERVER['REQUEST_URI']);
              ?>
              <a lang="fr" hreflang="fr" href=<?php echo $eng_link; ?> >
                <span class="hidden-xs">English</span>
                <abbr title="Français" class="visible-xs h3 mrgn-tp-sm mrgn-bttm-0 text-uppercase">eng</abbr>
              </a>
            </li>
          </ul>
        </section>
