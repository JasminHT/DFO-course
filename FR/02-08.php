...
<aside>
  <h3>Exemple : Recherche sur la structure des stocks de flétan de l’Atlantique</h3>

  <p>Des différences génétiques ont été constatées entre le flétan du golfe du Saint-Laurent et le flétan du plate-forme Néo-Écossais et du sud des Grands Bancs. Ces résultats justifient les unités de gestion actuelles (le flétan du golfe du Saint-Laurent est géré comme un seul stock et le flétan du plate-forme Néo-Écossais et du sud des Grands Bancs est géré comme un autre stock).</p>



<figure>
  <img src="../images/atlantic-halibut-genetic-sample-map-FR.jpg?v=1" alt="Carte des endroits où des échantillons génétiques de flétan de l’Atlantique ont été prélevés.">
</figure>
      ...
      <div class="mwsaccordion-html section">
        ...
        <details>
            ...
            <div class="mwsbodytext text parbase section">
              <p>Cette carte montre les endroits où des échantillons génétiques de flétan de l’Atlantique ont été prélevés le long de la côte est du Canada. Les cercles de différentes couleurs représentent les zones de prélèvement.</p>
            </div>
        </details>
