...
<figure>
  ...
  <figcaption>Casier sur le pont d’un bateau de pêche commerciale.
<br>
   Source de la photo: Kendra Holt, MPO
...
<aside class='bg-info'>
  ...
  <ul>
    <li>l’espèce ciblée (p. ex. pêche au hareng) ou les groupes d’espèces (p. ex. pêche aux poissons de fond ou pélagiques)&nbsp;;</li>
    <li>la méthode de pêche (p. ex. pêche à la senne, pêche au chalut).</li>
  </ul>
  <p>Certaines pêches ont lieu au cours d’une saison précise et  d’autres toute l’année. </p>
